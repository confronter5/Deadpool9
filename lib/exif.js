 ...
 * Uses system FFmpeg instead of deprecated ffmpeg-installer
 */
...
// Ensure tmp directory exists (critical for Heroku)
const tmpDir = path.join(process.cwd(), 'tmp')
if (!fs.existsSync(tmpDir)) {
    fs.mkdirSync(tmpDir, { recursive: true })
}

// Set FFmpeg path - Heroku has it in PATH, locally you need it installed
